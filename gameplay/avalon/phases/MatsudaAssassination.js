...
class LAssassination {
                        ...
                        this.thisRoom.specialRoles["Mikami"].playerShot = selectedPlayers;
                         ...
                         if (indexOfTarget !== -1) {
                            if (this.thisRoom.playersInGame[indexOfTarget].role === "Matsuda") {
                                ...
                                this.thisRoom.howWasWon = "Assassinated every detective.";
                                
                                this.thisRoom.sendText(this.thisRoom.allSockets, "The assassin has shot " + MatsudaUsername + "! They were correct!", "gameplay-text-red");
                            }
                            else {
                                this.thisRoom.winner = "Detective";
                                this.thisRoom.howWasWon = "Matsuda survived assassination.";
                                
                                // console.log("THIS WAS RUN ONCE");
                                this.thisRoom.sendText(this.thisRoom.allSockets, "The assassin has shot " + selectedPlayers + "! " + selectedPlayers + " was not Matsuda, " + MatsudaUsername + " was!", "gameplay-text-blue");
                            }
    ...
    getStatusMessage (indexOfPlayer) {
        ...
        if (indexOfPlayer === indexOfAssassin) {
            return "Assassinate Matsuda."
        }
        // If it is any other player who isn't special role
        else {
            var usernameOfAssassin = this.thisRoom.playersInGame[indexOfAssassin].username;
            return "Waiting for " + usernameOfAssassin + " to assassinate Matsuda."
        }
    }
...
module.exports = MatsudaAssassination;
