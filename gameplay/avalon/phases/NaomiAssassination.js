...
class NaomiAssassination {
                    ...
                    if (selectedPlayers.length === 1) {
                        ...
                        if (indexOfTarget !== -1) {
                            if (this.thisRoom.playersInGame[indexOfTarget].role !== "Naomi") {
                                ...
                                this.thisRoom.sendText(this.thisRoom.allSockets, "Mikami tried to assassinate " + selectedPlayers + "! " + selectedPlayers + " was not Naomi, " + NaomiUsername + " was!", "gameplay-text-blue");
                            ...
                            this.thisRoom.finishGame(this.thisRoom.winner);
                                ...
                                this.thisRoom.allSockets, "Mikami has assassinated " + NaomiUsername + "! They were correct!", "gameplay-text-red");
                                this.thisRoom.phase = "WatariAssassination"
    ...
    getStatusMessage (indexOfPlayer) {
        ...
        if (indexOfPlayer === indexOfAssassin) {
            return "Assassinate Naomi."
        }
        // If it is any other player who isn't special role
        else {
            var usernameOfMikami = this.thisRoom.playersInGame[indexOfAssassin].username;
            return "Waiting for " + usernameOfMikami + " to assassinate Naomi."
        }
    }
...
module.exports = NaomiAssassination;
